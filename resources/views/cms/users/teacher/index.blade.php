...
@section('toolbar-title','كافة المعلمين')
@section('breadcrumb','لوحة التحكم')
@section('sub-breadcrumb','قائمة المعلمين')
@section('style')
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-author-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="بحث المعلمين" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        <!--begin::Toolbar-->
                        <div class="d-flex justify-content-end" data-kt-author-table-toolbar="base">
                            <!--begin::Filter-->
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <!--begin::Content-->
                                <div class="px-7 py-5" data-kt-author-table-filter="form">
                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-semibold">الدور:</label>
                                        <select class="form-select form-select-solid fw-bold" data-control="select2" data-kt-select2="false" data-placeholder="حدد خياراً" data-allow-clear="true" data-kt-author-table-filter="role" data-hide-search="true">
                                            <option></option>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" data-kt-author-table-filter="reset">اعادة</button>
                                        <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-author-table-filter="filter">تطبيق</button>
                                    </div>
                                    <!--end::Actions-->
                                </div>
                                <!--end::Content-->
                            ...
                            <!--end::Filter-->
                            <!--begin::Export-->
                            <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_export_authors">
                            ...
                            <!--end::Export-->
                            <!--begin::Add users-->
                            @if (userHasPermission('teacher', 'can-add'))

                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_author">
                                <i class="ki-duotone ki-plus fs-2"></i>اضافة معلم</button>
                            <!--end::Add users-->
                            @endif
                        </div>
                        ...
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-author-table-toolbar="selected">
                            <div class="fw-bold me-5">
                                <span class="me-2" data-kt-author-table-select="selected_count"></span>محدد</div>
                            <button type="button" class="btn btn-danger" data-kt-author-table-select="delete_selected">حذف المحدد</button>
                        </div>
                        <!--end::Group actions-->
                        <!--begin::Modal - Adjust Balance-->
                        <div class="modal fade" id="kt_modal_export_authors" tabindex="-1" aria-hidden="true">
                            <!--begin::Modal dialog-->
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bold">تصدير المعلمين</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-authors-modal-action="close">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        <!--begin::Form-->
                                        <form id="kt_modal_export_authors_form" class="form" action="#">
                                            <!--begin::Input group-->
                                            ...
                                            <div class="text-center">
                                                <button type="reset" class="btn btn-light me-3" data-kt-authors-modal-action="cancel">تجاهل</button>
                                                <button type="submit" class="btn btn-primary" data-kt-authors-modal-action="submit">
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="kt_modal_add_author_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bold">اضافة معلم</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-authors-modal-action="close">
                                            <i class="ki-duotone ki-cross fs-1">
                                    ...
                                    <div class="modal-body px-5 my-7">
                                        <!--begin::Form-->
                                        <form id="kt_cms_add_author_form" class="form" action="{{route('teachers.store')}}" data-kt-redirect="{{route('teachers.index')}}" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            <!--begin::Scroll-->
                                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_author_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_author_header" data-kt-scroll-wrappers="#kt_modal_add_author_scroll" data-kt-scroll-offset="300px">
                                                <!--begin::Input group-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <div class="me-5">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <div class="fs-7 fw-semibold text-muted">عليك تعيين حالة المحرر ليتمكن من الدخول الى النظام</div>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Label-->
                                                        <!--begin::Switch-->
                                            ...
                                            <div class="text-center pt-10">
                                                <button type="reset" class="btn btn-light me-3" data-kt-authors-modal-action="cancel">الغاء</button>
                                                <button type="submit" class="btn btn-primary" data-kt-authors-modal-action="submit">
                                                    <span class="indicator-label">تأكيد</span>
                                                    <span class="indicator-progress">الرجاء الانتظار...
																	<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                ...
                <div class="card-body py-4">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_authors">
                        <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_table_authors .form-check-input" value="1" />
                                </div>
                            </th>
                            <th class="min-w-125px">المحرر</th>
...
@section('scripts')
    ...
    <script src="{{asset('assets/js/cms/user-management/teacher/add-teacher.js')}}"></script>
    <script src="{{asset('assets/js/cms/user-management/teacher/teacher-table.js')}}"></script>
    <script src="{{asset('assets/js/cms/user-management/teacher/edit-teacher.js')}}"></script>
