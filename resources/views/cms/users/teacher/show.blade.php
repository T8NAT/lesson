...
@section('style')
    <meta name="author_id" content="{{$author->id}}">
@endsection
@section('content')
    <!--begin::Content-->
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        ...
                        <li class="nav-item ms-auto">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="#" class="menu-link text-danger px-5">حذف المحرر</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-center flex-column py-5">
                                            ...
                                            @if(isset($author->avatar))
                                                <div class="symbol symbol-100px symbol-circle mb-7">
                                                    <img src="{{Storage::url($author->avatar)}}" alt="image" />
                                                </div>
                                            @else
                                                <div class="symbol symbol-100px symbol-circle mb-7">
                                            ...
                                            <!--end::Avatar-->
                                            <!--begin::Name-->
                                            <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{$author->name}}</a>
                                            <!--end::Name-->
                                            <!--begin::Position-->
                                            <div class="mb-9">
                                                <!--begin::Badge-->
                                                <div class="badge badge-lg badge-light-primary d-inline">{{$author->role->name}}</div>
                                                <!--begin::Badge-->
                                            </div>
                                            <!--end::Position-->
                                        </div>
                                        ...
                                        <div id="kt_user_view_details" class="collapse show">
                                            <div class="pb-5 fs-6">
                                                ...
                                                <div class="text-gray-600">{{$author->id}}</div>
                                                <!--begin::Details item-->
                                                <!--begin::Details item-->
                                                <div class="fw-bold mt-5">البريد الالكتروني</div>
                                                <div class="text-gray-600">
                                                    <a href="#" class="text-gray-600 text-hover-primary">{{$author->email}}</a>
                                                </div>
                                                <!--begin::Details item-->
                                                ...
                                                <div class="text-gray-600">{{$author->last_login}}</div>
                                                <!--begin::Details item-->
                                            </div>
                                        </div>
                                        <!--end::Details content-->
            ...
            <div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <!--begin::Form-->
                        <form class="form" action="" method="POST" enctype="multipart/form-data" id="kt_modal_update_author_form">
                       @method('PUT')
                            @csrf
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_update_author_header">
                                <!--begin::Modal title-->
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_author_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_author_header" data-kt-scroll-wrappers="#kt_modal_update_author_scroll" data-kt-scroll-offset="300px">
                                    <!--begin::User toggle-->
                                    ...
                                    <div id="kt_modal_update_user_user_info" class="collapse show">
                                        ...
                                        <div class="mb-7">
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{Storage::url($author->avatar)}}"></div>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name" id="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ادخل الاسم بالكامل هنا" value="{{$author->name}}" />
                                            <!--end::Input-->
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="user_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ادخل اسم المستخدم" value="{{$author->user_name}}" />
                                            <!--end::Input-->
...
{{--                                            <!--end::Label-->--}}
{{--                                            <!--begin::Input-->--}}
{{--                                            <input type="email" name="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" value="{{$teacher->email}}" />--}}
{{--                                            <!--end::Input-->--}}
...
{{--                                        </div>--}}
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="tel" name="phone_number" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{trans('dashboard_trans.Phone')}}" value="{{$author->phone_number}}" />
                                            <!--end::Input-->
                                            ...
                                            <div class="col-md-9">
                                                <div class="d-flex mt-3">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid me-5">
                                                        <input class="form-check-input" type="radio" value="male" @checked($author->gender === 'male') name="gender" id="gender_male" >
                                                        <label class="form-check-label" for="gender_male">ذكر</label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="radio" value="female"  @checked($author->gender === 'female') name="gender" id="gender_female">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <label class="form-check form-switch form-check-custom form-check-solid">
                                                    <!--begin::Input-->
                                                    <input class="form-check-input" name="status" type="checkbox"  id="status" @checked($author->status == 'active')>
                                                    <!--end::Input-->
                                                </label>
                                                <!--end::Switch-->
                                            </div>
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_modal_update_email_form" method="POST" class="form" action="#" enctype="multipart/form-data">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" placeholder="example@cardio.com" name="email" value="{{$author->email}}" />
                                <!--end::Input-->
                                @error('email')
                        ...
                        <form id="kt_modal_update_role_form" class="form" action="#" method="POST">
                            ...
                            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">{{trans('dashboard_trans.Please note that reducing a users role rank, that users will lose all privileges that was assigned to the previous role')}}.</div>
                                    </div>
                                    <!--end::Content-->
                                </div>
                                <!--end::Wrapper-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input me-3"  name="role_id" value="{{$role->id}}" type="radio"  id="role_id" @checked($author->role_id == $role->id) />
                                        <!--end::Input-->
                                        <!--begin::Label-->
...
@endsection
@section('scripts')
    <script src="{{asset('assets/js/cms/user-management/teacher/update-details.js')}}"></script>
    <script src="{{asset('assets/js/cms/user-management/teacher/update-email.js')}}"></script>
    <script src="{{asset('assets/js/cms/user-management/teacher/update-password.js')}}"></script>
    <script src="{{asset('assets/js/cms/user-management/teacher/update-role.js')}}"></script>
@endsection
