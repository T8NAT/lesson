...
@section('toolbar-title','اضافة صوت جديد')
@section('breadcrumb','كافة الاصوات')
@section('sub-breadcrumb','اضافة صوت جديد')
    @section('content')
        <!--begin::Heading-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form id="kt_add_audio_form" action="{{ route('audios.store') }}" enctype="multipart/form-data" method="POST" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('audios.create')}}">
                 @csrf
                    <!--begin::Main column-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="name" id="name"  class="form-control mb-2" placeholder="{{'قم بادخال اسم الصوت هنا'}}" value="{{old('name')}}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
