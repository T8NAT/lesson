...
@section('content')
    ...
    <div class="card-border mb-13 text-center">
        <!--begin::Title-->
        <h1 class="mb-3">اضافة لعبة جديدة</h1>
        <!--end::Title-->
        <!--begin::Description-->
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form id="kt_add_game_form" action="{{ route('games.store') }}" enctype="multipart/form-data" method="POST" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('games.create')}}">
                @csrf
                <!--begin::Aside column-->
