                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-game-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="{{'بحث الالعاب'}}" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--end::Card title-->
...
{{--                    @if (userHasPermission('game', 'can-add'))--}}
                        <div class="card-toolbar">
                            <!--begin::Add customer-->
                            <a href="{{ route('games.create') }}" class="btn btn-primary">{{'اضافة لعبة'}}</a>
                            <!--end::Add customer-->
                        </div>
{{--                    @endif--}}
                    <!--end::Card toolbar-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_game_table">
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-250px">{{'اسم اللعبة'}}</th>
                            <th class="min-w-250px">{{'نوع اللعبة'}}</th>
                            <th class="min-w-250px">{{'القسم'}}</th>
                            <th class="min-w-150px">{{'حالة اللعبة'}}</th>
