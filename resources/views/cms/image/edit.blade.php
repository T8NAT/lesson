...
@section('toolbar-title','تعديل الصورة')
@section('breadcrumb','كافة الصور')
@section('sub-breadcrumb','تعديل الصورة')
@section('content')
    <!--begin::Heading-->
    <div class="card-border mb-13 text-center">
        <!--begin::Title-->
        <h1 class="mb-3">تعديل الصورة</h1>
        <!--end::Title-->
        <!--begin::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                                ...
                                <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{Storage::url($image->image)}})"></div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" id="name"  class="form-control mb-2" placeholder="{{'قم بادخال اسم الصورة هنا'}}" value="{{old('name',$image->name)}}" />
                                <!--end::Input-->
                                <!--begin::Description-->
