<div class="text-end" data-type-id="{{ $row->id }}" data-type-name="{{ $row->name }}">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
        <!--begin::Menu item-->
        @if (userHasPermission('type', 'can-edit'))
        ...
        <!--end::Menu item-->
        <!--begin::Menu item-->
        @if (userHasPermission('type', 'can-delete'))
            <div class="menu-item px-3">
                <a href="#" class="menu-link px-3" data-kt-type-filter="delete_row">{{ 'حذف' }}</a>
            </div>
        @endif
        <!--end::Menu item-->
    </div>
