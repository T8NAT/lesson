...
var URL1 = '/dashboard/teacher-update-email/' + author_id;

var KTAuthorUpdateEmail = function () {
    ...
    return {
        init: function () {
            (() => {
                ...
                })), t.querySelector('[data-kt-authors-modal-action="cancel"]').addEventListener("click", (t => {
                    t.preventDefault(), Swal.fire({
                        text: "هل انت متأكد من الالغاء؟",
                        icon: "warning",
                        showCancelButton: !0,
