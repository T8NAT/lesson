"use strict";
var KTAppSaveType = function () {

    const initTypeForm = () => {
        const form = document.getElementById("kt_cms_add_type_form");
        const submitButton = form.querySelector("button[type='submit']");
        const cancelButton = form.querySelector('[data-kt-types-modal-action="cancel"]');
        const modalElement = document.getElementById("kt_modal_add_type");
        const modal = new bootstrap.Modal(modalElement);
        const closeButton = modalElement.querySelector('[data-kt-types-modal-action="close"]');
